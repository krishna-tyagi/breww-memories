...
const steps = [
  {
    ...
    desc: "We listen — to your team, your goals, your culture. The brief shapes everything.",
  },
  {
    n: "02",
    title: "Curate the experience",
    desc: "Destinations, stays, vendors, moments. A design document, not a spreadsheet.",
  },
  {
    n: "03",
    title: "Execute flawlessly",
    desc: "On-ground hospitality, real-time problem solving, a calm presence behind the scenes.",
  },
  {
    n: "04",
    title: "Brew unforgettable memories",
    desc: "The kind your team retells for years — and your leadership remembers in every review.",
  },
];
            ...
            {steps.map((s, i) => (
              ...
              >
                <div className={`pl-20 lg:pl-0 ${i % 2 ? "lg:pl-16" : "lg:pr-16 lg:text-right"}`}>
                  <p className="font-display text-7xl lg:text-8xl bg-gradient-gold bg-clip-text text-transparent">
                    {s.n}
                  </p>
                  <h3 className="font-display text-3xl lg:text-4xl text-espresso mt-2">
                    {s.title}
                  </h3>
                  <p className="text-charcoal/70 mt-3 leading-relaxed max-w-md lg:ml-auto">
                    {s.desc}
                  </p>
                </div>
