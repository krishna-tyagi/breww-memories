...
export function Contact() {
  const items = [
    ...
    { icon: MessageCircle, label: "WhatsApp", value: "+91 87967-02220", href: "https://wa.me/918796702220" },
    { icon: Mail, label: "Email", value: "brewwmemories@gmail.com", href: "mailto:brewwmemories@gmail.com" },
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-start">
        <div className="space-y-7">
          ...
          <Reveal delay={0.2}>
            <p className="text-lg text-charcoal/70 max-w-md">
              Call, message or write to us. We respond personally — usually within a few hours during business days.
            </p>
          </Reveal>
                ...
                return (
                  <li key={it.label}>
                    <Comp
                      ...
                      rel="noreferrer"
                      className="flex items-center gap-4 rounded-2xl border border-border bg-card/60 backdrop-blur-sm p-5 hover:border-gold hover:-translate-y-0.5 hover:shadow-soft transition-all duration-500 ease-luxe"
                    >
                      ...
                      <span className="flex flex-col">
                        <span className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground">{it.label}</span>
        ...
        <Reveal delay={0.2}>
          <div className="relative rounded-3xl overflow-hidden border border-border shadow-deep h-[480px] lg:h-[560px] bg-gradient-espresso">
            ...
            />
            <div className="absolute bottom-5 left-5 right-5 rounded-2xl backdrop-blur-xl bg-cream/85 p-5 border border-border">
              <p className="font-display text-xl text-espresso">Based in Delhi NCR</p>
              <p className="text-sm text-charcoal/70 mt-1">Designing experiences across India and beyond.</p>
            </div>
          </div>
        </Reveal>
      </div>
