...
export function Footer() {
  return (
    <footer className="relative bg-gradient-espresso text-cream grain overflow-hidden">
      <div className="absolute inset-0 footer-ambient pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="grid grid-cols-2 gap-3">
              {links.map((l) => (
                <li key={l.href}>
                  <a href={l.href} className="text-cream/85 hover:text-gold transition-colors">
                    {l.label}
                  </a>
                </li>
              ))}
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="flex gap-3 pt-1">
              <a
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-cream/20 hover:bg-gold hover:border-transparent hover:text-espresso transition-all duration-500 ease-luxe"
              >
                <Instagram size={16} />
              </a>
              <a
